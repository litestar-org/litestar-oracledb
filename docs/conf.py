...
from litestar_oracledb.__metadata__ import __project__ as project
from litestar_oracledb.__metadata__ import __version__ as version
...
author = "Cody Fincher"
release = version
release = os.getenv("_LITESTAR-ORACLEDB_DOCS_BUILD_VERSION", version.rsplit(".")[0])
copyright = "2024, Cody Fincher"  # noqa: A001
...
intersphinx_mapping = {
    ...
    "oracledb": ("https://magicstack.github.io/oracledb/current/", None),
...
html_theme_options = {
    ...
    "nav_links": [
        {"title": "Home", "url": "https://litestar-org.github.io/litesatr-oracledb/"},
        {"title": "Docs", "url": "https://litestar-org.github.io/litesatr-oracledb/latest/"},
        {"title": "Code", "url": "https://github.com/litestar-org/litestar-oracledb"},
    ],
    "light_css_variables": {
        # RGB
